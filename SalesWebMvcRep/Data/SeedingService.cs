...
using SalesWebMvcRep.Models.Enum;

namespace SalesWebMvcRep.Data
{
    public class SeedingService
    {
        private SalesWebMvcRepContext _context;

        public SeedingService(SalesWebMvcRepContext context)
        {
            _context = context;
        }
