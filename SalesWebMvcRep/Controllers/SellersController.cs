...
namespace SalesWebMvcRep.Controllers
{
    ...
    {
        private readonly SalesWebMvcRepContext _context;

        public SellersController(SalesWebMvcRepContext context)
        {
            _context = context;
        }
        ...
        {
            var salesWebMvcRepContext = _context.Seller.Include(s => s.Department);
            return View(await salesWebMvcRepContext.ToListAsync());
        }
